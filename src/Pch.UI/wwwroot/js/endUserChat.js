...
function sendPrompt() {
    ...
    appendTurn("turn-provider-role-status", "provider", "role-status", liveSelected ? "blocked" : "applied", liveSelected
        ...
        : "Offline deterministic model role is active by explicit selection.", "model_role_status_ready");
    if (liveSelected) {
